...
export const artists: Artist[] = [
  ...
  },
  {
    ...
    biography: {
      ...
      ru: "Родился в Румынии, Пауль провёл два года в лагере принудительного труда в Польше. Репатриировавшись в Израиль в 1970 году, посвятил жизнь театру и искусству, доказав, что творчество может выжить в самых тяжёлых условиях."
    },
